 ...
 *
 * Returns a new connection object, with the new settings.js.
 *
...
NativeConnection.prototype.useDb = function(name) {
  ...
  // First, when we create another settings.js object, we are not guaranteed to have a
  // settings.js object to work with. So, in the case where we have a settings.js object and it
  // is connected, we can just proceed with setting everything up. However, if
  // we do not have a settings.js or the state is not connected, then we need to wait on
  // the 'open' event of the connection before doing the rest of the setup
  // the 'connected' event is the first time we'll have access to the settings.js object
...
/*!
 * Validates the driver settings.js options.
 *
 * @param {Object} o
 */
