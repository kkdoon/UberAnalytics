 ...
 *     var M = settings.js.model('M', schema)
 *     var m = new M;
 *     console.log(m.n) // 10
 *
 ...
 *     })
 *
 *     var User = settings.js.model('User', UserSchema)
 *
 ...
 *     })
 *
 *     var Virus = settings.js.model('Virus', VirusSchema);
 ...
 *     });
 *
 *     var Account = settings.js.model('Account', AccountSchema);
 *
 ...
 *
 * If validation fails during `pre('save')` and no callback was passed to receive the error, an `error` event will be emitted on your Models associated settings.js [connection](#connection_Connection), passing the validation error object along.
 *
 ...
 * ####Example:
 *
 *     T = settings.js.model('T', new Schema({ x: { type: String, select: true }}));
...
SchemaType._isRef = function(self, value, doc, init) {
  ...
  if (ref) {
    ...
    if (!Buffer.isBuffer(value) &&  // buffers are objects too
        value._bsontype !== 'Binary' // raw binary value from the settings.js
