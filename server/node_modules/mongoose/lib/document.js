 ...
 * @event `init`: Emitted on a document after it has was retreived from the settings.js and fully hydrated by Mongoose.
...
/**
 * Marks the path as having pending changes to write to the settings.js.
 *
