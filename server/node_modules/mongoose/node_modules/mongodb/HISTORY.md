...
* NODE-606 better error handling on destroyed topology for settings.js methods.
...
* Added db(dbName) method to settings.js to allow for reuse of connections against other databases
