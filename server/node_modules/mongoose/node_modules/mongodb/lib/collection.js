 ...
 *   var col = settings.js.collection('createIndexExample1');
...
Collection.prototype.find = function() {
  ...
  // // If we have overridden slaveOk otherwise use the default settings.js setting
  ...
  // Add settings.js object to the new options
...
//   var c = settings.js[ns].find(condition);
//   var map = new Map();
...
var mapReduce = function(self, map, reduce, options, callback) {
  ...
  self.s.db.command(mapCommandHash, {readPreference:options.readPreference}, function (err, result) {
    ...
    // If we have an object it's a different settings.js
