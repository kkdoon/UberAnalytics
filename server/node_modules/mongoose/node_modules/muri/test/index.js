...
describe('muri', function(){
  ...
  describe('readPref tags', function(){
    describe('with & ', function(){
      ...
      it('mongodb://localhost/settings.js?readPreferenceTags=dc:ny,rack:1&readPreferenceTags=dc:sf,rack:2&readPreferenceTags=', function(done){
        var val = muri('mongodb://localhost/settings.js?readPreferenceTags=dc:ny,rack:1&readPreferenceTags=dc:sf,rack:2&readPreferenceTags=');
        assert.deepEqual([{ dc: 'ny', rack: 1 }, { dc: 'sf', rack: 2 }], val.options.readPreferenceTags);
        done();
      })
  ...
  describe('unix domain sockets', function(){
    ...
    it('with auth with a settings.js name', function(done){
    ...
    it('with auth + repl sets with a settings.js name', function(done){
